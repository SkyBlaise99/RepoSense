...
public class StandaloneConfigJsonParserTest {
    ...
    public static void setUp() throws Exception {
        ...
        expectedFullRepoConfig.addAuthorAliasesToAuthorMapEntry(author, Arrays.asList(author.getGitId()));
        expectedFullRepoConfig.addAuthorAliasesToAuthorMapEntry(author, author.getAuthorAliases());
        expectedFullRepoConfig.addAuthorEmailsToAuthorMapEntry(author, author.getEmails());
    }
