...
public class RepoConfigParserTest {
    ...
    public void merge_twoRepoConfigs_success() throws Exception {
        ...
        firstRepo.addAuthorAliasesToAuthorMapEntry(SECOND_AUTHOR, Arrays.asList("Zachary Tang"));
        ...
        secondRepo.addAuthorAliasesToAuthorMapEntry(SECOND_AUTHOR, Arrays.asList("Zachary Tang"));
    ...
    public void merge_emptyLocation_success() throws Exception {
        ...
        expectedBetaConfig.addAuthorAliasesToAuthorMapEntry(SECOND_AUTHOR, Arrays.asList("Zachary Tang"));
