...
public class CommitInfoAnalyzerTest extends GitTestTemplate {
    ...
    public void analyzeCommits_allAuthorNoIgnoredCommitsNoDateRange_success() {
        config.addAuthorAliasToAuthorMapEntry(MAIN_AUTHOR_NAME, new Author(MAIN_AUTHOR_NAME));
        config.addAuthorAliasToAuthorMapEntry(FAKE_AUTHOR_NAME, new Author(FAKE_AUTHOR_NAME));
        config.addAuthorAliasToAuthorMapEntry(EUGENE_AUTHOR_NAME, new Author(EUGENE_AUTHOR_NAME));
    ...
    public void analyzeCommits_noCommitMessage_success() {
        ...
        config.getAuthorDetailsToAuthorMap().clear();
        config.addAuthorAliasToAuthorMapEntry(YONG_AUTHOR_NAME, new Author(YONG_AUTHOR_NAME));
